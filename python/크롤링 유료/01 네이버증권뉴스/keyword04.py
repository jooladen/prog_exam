...
params['hintKeywords']='OLAP'
params['hintKeywords']='엑셀자동화'
params['hintKeywords']='채용공고'
params['hintKeywords']='가격비교'
params['hintKeywords']='부동산매물'
params['hintKeywords']='부동산'
params['hintKeywords']='개발자'
params['hintKeywords']='정보처리기사'
params['hintKeywords']='자동화'
params['hintKeywords']='웹크롤링'
params['hintKeywords']='채용정보'
params['hintKeywords']='키워드'
params['hintKeywords']='블로그키워드'
params['hintKeywords']='네이버블로그'
params['hintKeywords']='핵심어'
params['hintKeywords']='트리거'
params['hintKeywords']='포화도'
params['hintKeywords']='상위노출'
params['hintKeywords']='골프'
params['hintKeywords']='강아지'
params['hintKeywords']='골프스윙'
params['hintKeywords']='블로거'
params['hintKeywords']='상위노출'
params['hintKeywords']='블로그'
params['hintKeywords']='CHATGPT'
params['hintKeywords']='크롤링'
params['hintKeywords']='IT'
...
if 'keywordList' in response:
    ...
    raise KeyError("응답에 'keywordList'가 없습니다. 검색어 확인해보세요")
...
def analyze_keyword_density(result, monthly_search_volume):
    ...
    #return f"{rounded_percent}%", message, round(monthly_post, 1)
    return rounded_percent, message, round(monthly_post, 1)
    # if (15.0 <= percentage <= 25.0):
...
#for i in range(0, len(keyword_lists)):    
    ...
    if not (200 <= pcCnt + mobileCnt <= 1000):
        continue
    ...
    if(rescode==200):
        ...
        percent, statusMsg, monthly_post = analyze_keyword_density(result, pcCnt + mobileCnt)
        ...
        if percent is None:
            continue  # 퍼센트 범위 안 맞으면 제외

        excel_rows.append({
            "키워드": data_list[i]['relKeyword'],
            "PC 검색량": pcCnt,
            "MO 검색량": mobileCnt,
